...
BookingRequestService.GetRequestsByStatus = {
...
BookingRequestServiceClient.prototype.getRequestsByStatus = function getRequestsByStatus(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(BookingRequestService.GetRequestsByStatus, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
